    ...
    for tracker in upload_to_trackers:
        ...
        if "bbcode_images" in torrent_info:
            ...
            with open(torrent_info["bbcode_images"], 'r') as bbcode, open(f'{working_folder}/temp_upload/description.txt', 'a') as description:
                ...
                description.write(f'[center][quote][size=16][color=#3774F6][b]{torrent_info["torrent_title"]}[/b][/color][/size][/quote]')
                description.write(f'{bbcode_line_break}[size=20][b]-SCREENSHOTS-[/b][/size]{bbcode_line_break}{bbcode_line_break}')

                # Now write in the actual screenshot bbcode
                for line in bbcode:
                    description.write(line)

                # TROUT Description "after" screenshots
                description.write(f'{bbcode_line_break}{bbcode_line_break}[quote][size=16]With a name like [color=#3774F6][b]TROUT[/b][/color], it has to be good[/size][/quote]')
                description.write(f'{bbcode_line_break}[img]https://beyondhd.co/images/2021/05/02/6d61ce3c20451cdc3267f9879b9485e1.png[/img][/center]')
